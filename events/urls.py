...
urlpatterns = [
    ...
    # hackathon urls
    path("hackathon/", views.hackathon_home, name="hackathon_home"),
    path("hackathon/selectCollege/<str:hackathon_name>", views.select_hackathon_college, name="hackathon_selectCollege"),
]

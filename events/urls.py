...
urlpatterns = [
    ...
    path("select_college/<str:sport_name>", views.selectCollege, name="selectCollege"), # URL Working
    ...
    path("hackathon/selectCollege/<str:hackathon_name>", views.select_hackathon_college, name="hackathon_selectCollege"), # URL Working
    path("hackathon/register/<str:hackathon_name>", views.register_hackathon, name="hackathon_register"),   # URL Working
    path("hackathon/success/<str:team_hash>", views.hackathon_success, name="hackathon_success"), # URL Working
    path("hackathon/registered_teams", views.hackathon_admin, name="hackathon_admin"),
    path("hackathon/view_team/<str:team_hash>", views.view_hackathon_team, name="view_hackathon_team"),
]

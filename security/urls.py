...
urlpatterns = [
    ...
    path('maingate/' , views.festpass_scan , name='maingate_scan'),
    path('maingate1/' , views.festpass_scan1 , name='maingate_scan1'),
    path('maingateverify/', views.festpass_verify, name='maingateverify'),
]
...
class Sport(models.Model):
    ...
    match_img = models.ImageField(
        upload_to=sports_matches_file_upload_path, null=True, blank=True
    )
    points_img = models.ImageField(
        upload_to=sports_points_file_upload_path, null=True, blank=True
    )

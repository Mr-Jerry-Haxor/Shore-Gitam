...
class payments_kalakrithi(models.Model):
...
class registrations_kalakrithi(models.Model):
...
class Fest_entries_kalakrithi(models.Model):
    STATUS_CHOICES = [
        ('IN', 'In'),
        ('OUT', 'Out'),
    ]
...
class Fest_status_kalakrithi(models.Model):
    fullname = models.CharField(max_length=300, null=True, blank=True)

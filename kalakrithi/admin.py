...
admin.site.register(payments_kalakrithi, PaymentsAdmin)
admin.site.register(registrations_kalakrithi, RegistrationsAdmin)
admin.site.register(Fest_entries_kalakrithi, FestEntriesAdmin)
admin.site.register(Fest_status_kalakrithi, FestStatusAdmin)